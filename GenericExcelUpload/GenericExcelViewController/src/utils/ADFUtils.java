...
public class ADFUtils implements java.io.Serializable {
    ...
    */
    ...
    /**
     * method to return pageflow scope map
     * @return
     */
    ...
    /**
     * method to get session scope map
     * @return
     */
    public static Map<Object,Object> getSessionScope(){
        return ADFContext.getCurrent().getSessionScope();
    }
    /**
     * method to remove current row onClick of cancel
     * @param iterator
     */
    public static void removeTableCurrentRows(String iterator) {
        ViewObject vo = findIterator(iterator).getViewObject();
        RowSetIterator rowSetItr = vo.createRowSetIterator(null);
        while (rowSetItr.hasNext()) {
            rowSetItr.next().remove();
        }
        rowSetItr.closeRowSetIterator();
    }
    /**
     * method to remove current row 
     * @param iterator
     */
    public static void removeCurrentRow(String iterator) {
        ViewObject vo = findIterator(iterator).getViewObject();
